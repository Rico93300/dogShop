    ...
    <div class="container">
        ...
        <div class="d-flex">
            <div class="card m-3" style="width: 18rem">
                ...
                <img
                    src="img/IOKHEIA1.jpg"
                    class="card-img-top"
                    alt="dodo a chien"
                />
                <div class="card-body" class="border-0">
                    <h4 class="text-center"></h4>
                    <h5 class="card-title">
                        IOKHEIA <strong class="m-4"> 14.99€</strong>
                    </h5>
            ...
            <div class="card m-3" style="width: 18rem">
                ...
                />
                <div class="card-body">
                    <h5 class="card-title">PELUCHE <strong class="m-5">9€</strong></h5>
                    <p class="card-text">
            ...
            <div class="card m-3" style="width: 18rem">
                <img
                    src="img/COUINEUR.jpg"
                    class="card-img-top"
                    alt="..."
                />
                <div class="card-body">
                    <h5 class="card-title">COUINEUR <strong class="m-5"> 7€</strong></h5>
                    <p class="card-text">
            ...
            <div class="card m-3" style="width: 18rem">
                ...
                <div class="card-body">
                    <h5 class="card-title"> Balle Jouet<strong class="m-4"> 15€</strong></h5>
                    <p class="card-text">
        ...
        <div class="d-flex">
            <div class="card m-3" style="width: 18rem">
                <img
                    src="img/JouetsInteractifsCanin.jpg"
                    class="card-img-top"
            ...
            <div class="card m-3" style="width: 18rem">
                ...
                <div class="card-body">
                    <h5 class="card-title">JOPHEK<strong class="m-4"> 15€</strong></h5>
                    <p class="card-text">
            ...
            <div class="card m-3" style="width: 18rem">
                <img
                    src="img/atopo.jpg"class="card-img-top"
                    alt="jouet a macher"
                />
                <div class="card-body">
                    <h5 class="card-title">ATOPO<strong class="m-4"> 18.99€</strong></h5>
                    <p class="card-text">
                        atopo Chien Jouets à mâcher Résistant en Caoutchouc 13 inch Os Jouet en Forme de Chien Chiots avec Convex Design Jouet Chien interactif Solide pour Les Chewers Agressifs Petits et Grands Chiens
                    </p>
